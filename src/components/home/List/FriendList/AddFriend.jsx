...
const AddFriend = () => {
  ...
  return (
    ...
    <div className='flex items-center justify-center rounded-full cursor-pointer group text-zinc-100 hover:text-zinc-300 bg-gradient-to-tl from-purple-700 to-violet-800 group-hover:from-purple-900 group-hover:to-violet-800 px-3 mt-3' onClick={addNew}>
